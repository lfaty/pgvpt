...
public class BaseEntity {
  ...
  public BaseEntity id(@Nullable UUID id) {
    this.id = id;
    return this;
  }
  ...
  public BaseEntity createdAt(@Nullable OffsetDateTime createdAt) {
  ...
  public BaseEntity updatedAt(@Nullable OffsetDateTime updatedAt) {
