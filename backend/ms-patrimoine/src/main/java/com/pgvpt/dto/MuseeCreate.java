...
public class MuseeCreate implements PatrimoineCreate {
   ...
   */
  public MuseeCreate(String nom, TypeEnum type, CategoriePatrimoine categorie, String description, Localisation localisation, Integer nombreCollections) {
    this.nom = nom;
    this.type = type;
  ...
  public MuseeCreate type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public MuseeCreate localisation(Localisation localisation) {
    this.localisation = localisation;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, museeCreate.id) &&
        ...
        Objects.equals(this.localisation, museeCreate.localisation) &&
