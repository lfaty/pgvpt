...
@JsonSubTypes({
  @JsonSubTypes.Type(value = MonumentUpdate.class, name = "MONUMENT"),
  @JsonSubTypes.Type(value = MuseeUpdate.class, name = "MUSEE"),
  @JsonSubTypes.Type(value = SiteNaturelUpdate.class, name = "SITE_NATUREL")
})

@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", comments = "Generator version: 7.10.0")
public class PatrimoineUpdate {
   ...
   */
  public PatrimoineUpdate(String nom, String type, CategoriePatrimoine categorie, String description) {
    this.nom = nom;
    this.type = type;
  ...
  public PatrimoineUpdate id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public PatrimoineUpdate code(String code) {
    this.code = code;
    return this;
  }
  ...
  public PatrimoineUpdate nom(String nom) {
    this.nom = nom;
    return this;
  }
  ...
  public PatrimoineUpdate nomLocal(String nomLocal) {
  ...
  public PatrimoineUpdate nomHistorique(String nomHistorique) {
  ...
  public PatrimoineUpdate type(String type) {
    this.type = type;
    return this;
  }
  ...
  public PatrimoineUpdate categorie(CategoriePatrimoine categorie) {
    this.categorie = categorie;
    return this;
  }
  ...
  public PatrimoineUpdate sousCategorie(String sousCategorie) {
  ...
  public PatrimoineUpdate periode(PeriodeHistorique periode) {
  ...
  public PatrimoineUpdate siecle(String siecle) {
    this.siecle = siecle;
    return this;
  }
  ...
  public PatrimoineUpdate dateOuverture(LocalDate dateOuverture) {
  ...
  public PatrimoineUpdate description(String description) {
    this.description = description;
    return this;
  }
  ...
  public PatrimoineUpdate descriptionCourte(String descriptionCourte) {
  ...
  public PatrimoineUpdate historique(String historique) {
  ...
  public PatrimoineUpdate importanceHistorique(String importanceHistorique) {
  ...
  public PatrimoineUpdate importanceCulturelle(String importanceCulturelle) {
  ...
  public PatrimoineUpdate importanceTouristique(String importanceTouristique) {
  ...
  public PatrimoineUpdate valeurPatrimoniale(String valeurPatrimoniale) {
  ...
  public PatrimoineUpdate valeurSpirituelle(String valeurSpirituelle) {
  ...
  public PatrimoineUpdate traditionsAssociees(List<String> traditionsAssociees) {
    this.traditionsAssociees = traditionsAssociees;
    return this;
  }

  public PatrimoineUpdate addTraditionsAssocieesItem(String traditionsAssocieesItem) {
  ...
  public PatrimoineUpdate langues(List<String> langues) {
    this.langues = langues;
    return this;
  }

  public PatrimoineUpdate addLanguesItem(String languesItem) {
  ...
  public PatrimoineUpdate etatConservation(EtatConservation etatConservation) {
  ...
  public PatrimoineUpdate statut(StatutPatrimoine statut) {
    this.statut = statut;
    return this;
  }
  ...
  public PatrimoineUpdate classePatrimoine(Boolean classePatrimoine) {
  ...
  public PatrimoineUpdate referenceClassement(String referenceClassement) {
  ...
  public PatrimoineUpdate dateClassement(LocalDate dateClassement) {
  ...
  public PatrimoineUpdate inscritUnesco(Boolean inscritUnesco) {
  ...
  public PatrimoineUpdate nomSiteUnesco(String nomSiteUnesco) {
  ...
  public PatrimoineUpdate dateInscriptionUnesco(LocalDate dateInscriptionUnesco) {
  ...
  public PatrimoineUpdate protectionJuridique(String protectionJuridique) {
  ...
  public PatrimoineUpdate organismeGestionnaire(String organismeGestionnaire) {
  ...
  public PatrimoineUpdate proprietaire(String proprietaire) {
  ...
  public PatrimoineUpdate gestionnaire(String gestionnaire) {
  ...
  public PatrimoineUpdate contact(Contact contact) {
  ...
  public PatrimoineUpdate siteWeb(URI siteWeb) {
  ...
  public PatrimoineUpdate email(String email) {
    this.email = email;
    return this;
  }
  ...
  public PatrimoineUpdate telephone(String telephone) {
  ...
  public PatrimoineUpdate accessibilite(Accessibilite accessibilite) {
  ...
  public PatrimoineUpdate tarification(Tarification tarification) {
  ...
  public PatrimoineUpdate horaires(List<@Valid HoraireOuverture> horaires) {
    this.horaires = horaires;
    return this;
  }

  public PatrimoineUpdate addHorairesItem(HoraireOuverture horairesItem) {
  ...
  public PatrimoineUpdate photos(List<@Valid Photo> photos) {
    this.photos = photos;
    return this;
  }

  public PatrimoineUpdate addPhotosItem(Photo photosItem) {
    if (this.photos == null) {
  ...
  public PatrimoineUpdate medias(List<@Valid Media> medias) {
    this.medias = medias;
    return this;
  }

  public PatrimoineUpdate addMediasItem(Media mediasItem) {
    if (this.medias == null) {
  ...
  public PatrimoineUpdate conservation(Conservation conservation) {
  ...
  public PatrimoineUpdate menaces(List<@Valid Menace> menaces) {
    this.menaces = menaces;
    return this;
  }

  public PatrimoineUpdate addMenacesItem(Menace menacesItem) {
  ...
  public PatrimoineUpdate recommandationsVisiteur(List<String> recommandationsVisiteur) {
    this.recommandationsVisiteur = recommandationsVisiteur;
    return this;
  }

  public PatrimoineUpdate addRecommandationsVisiteurItem(String recommandationsVisiteurItem) {
  ...
  public PatrimoineUpdate reglesVisite(List<String> reglesVisite) {
    this.reglesVisite = reglesVisite;
    return this;
  }

  public PatrimoineUpdate addReglesVisiteItem(String reglesVisiteItem) {
  ...
  public PatrimoineUpdate activitesTouristiques(List<String> activitesTouristiques) {
    this.activitesTouristiques = activitesTouristiques;
    return this;
  }

  public PatrimoineUpdate addActivitesTouristiquesItem(String activitesTouristiquesItem) {
  ...
  public PatrimoineUpdate meilleurePeriodeVisite(String meilleurePeriodeVisite) {
  ...
  public PatrimoineUpdate dureeVisiteEstimeeMinutes(Integer dureeVisiteEstimeeMinutes) {
  ...
  public PatrimoineUpdate createdAt(OffsetDateTime createdAt) {
  ...
  public PatrimoineUpdate updatedAt(OffsetDateTime updatedAt) {
  ...
  public PatrimoineUpdate publishedAt(OffsetDateTime publishedAt) {
  ...
  public boolean equals(Object o) {
    ...
    PatrimoineUpdate patrimoineUpdate = (PatrimoineUpdate) o;
    return Objects.equals(this.id, patrimoineUpdate.id) &&
        Objects.equals(this.code, patrimoineUpdate.code) &&
        Objects.equals(this.nom, patrimoineUpdate.nom) &&
        Objects.equals(this.nomLocal, patrimoineUpdate.nomLocal) &&
        Objects.equals(this.nomHistorique, patrimoineUpdate.nomHistorique) &&
        Objects.equals(this.type, patrimoineUpdate.type) &&
        Objects.equals(this.categorie, patrimoineUpdate.categorie) &&
        Objects.equals(this.sousCategorie, patrimoineUpdate.sousCategorie) &&
        Objects.equals(this.periode, patrimoineUpdate.periode) &&
        Objects.equals(this.siecle, patrimoineUpdate.siecle) &&
        Objects.equals(this.dateOuverture, patrimoineUpdate.dateOuverture) &&
        Objects.equals(this.description, patrimoineUpdate.description) &&
        Objects.equals(this.descriptionCourte, patrimoineUpdate.descriptionCourte) &&
        Objects.equals(this.historique, patrimoineUpdate.historique) &&
        Objects.equals(this.importanceHistorique, patrimoineUpdate.importanceHistorique) &&
        Objects.equals(this.importanceCulturelle, patrimoineUpdate.importanceCulturelle) &&
        Objects.equals(this.importanceTouristique, patrimoineUpdate.importanceTouristique) &&
        Objects.equals(this.valeurPatrimoniale, patrimoineUpdate.valeurPatrimoniale) &&
        Objects.equals(this.valeurSpirituelle, patrimoineUpdate.valeurSpirituelle) &&
        Objects.equals(this.traditionsAssociees, patrimoineUpdate.traditionsAssociees) &&
        Objects.equals(this.langues, patrimoineUpdate.langues) &&
        Objects.equals(this.etatConservation, patrimoineUpdate.etatConservation) &&
        Objects.equals(this.statut, patrimoineUpdate.statut) &&
        Objects.equals(this.classePatrimoine, patrimoineUpdate.classePatrimoine) &&
        Objects.equals(this.referenceClassement, patrimoineUpdate.referenceClassement) &&
        Objects.equals(this.dateClassement, patrimoineUpdate.dateClassement) &&
        Objects.equals(this.inscritUnesco, patrimoineUpdate.inscritUnesco) &&
        Objects.equals(this.nomSiteUnesco, patrimoineUpdate.nomSiteUnesco) &&
        Objects.equals(this.dateInscriptionUnesco, patrimoineUpdate.dateInscriptionUnesco) &&
        Objects.equals(this.protectionJuridique, patrimoineUpdate.protectionJuridique) &&
        Objects.equals(this.organismeGestionnaire, patrimoineUpdate.organismeGestionnaire) &&
        Objects.equals(this.proprietaire, patrimoineUpdate.proprietaire) &&
        Objects.equals(this.gestionnaire, patrimoineUpdate.gestionnaire) &&
        Objects.equals(this.contact, patrimoineUpdate.contact) &&
        Objects.equals(this.siteWeb, patrimoineUpdate.siteWeb) &&
        Objects.equals(this.email, patrimoineUpdate.email) &&
        Objects.equals(this.telephone, patrimoineUpdate.telephone) &&
        Objects.equals(this.accessibilite, patrimoineUpdate.accessibilite) &&
        Objects.equals(this.tarification, patrimoineUpdate.tarification) &&
        Objects.equals(this.horaires, patrimoineUpdate.horaires) &&
        Objects.equals(this.photos, patrimoineUpdate.photos) &&
        Objects.equals(this.medias, patrimoineUpdate.medias) &&
        Objects.equals(this.conservation, patrimoineUpdate.conservation) &&
        Objects.equals(this.menaces, patrimoineUpdate.menaces) &&
        Objects.equals(this.recommandationsVisiteur, patrimoineUpdate.recommandationsVisiteur) &&
        Objects.equals(this.reglesVisite, patrimoineUpdate.reglesVisite) &&
        Objects.equals(this.activitesTouristiques, patrimoineUpdate.activitesTouristiques) &&
        Objects.equals(this.meilleurePeriodeVisite, patrimoineUpdate.meilleurePeriodeVisite) &&
        Objects.equals(this.dureeVisiteEstimeeMinutes, patrimoineUpdate.dureeVisiteEstimeeMinutes) &&
        Objects.equals(this.createdAt, patrimoineUpdate.createdAt) &&
        Objects.equals(this.updatedAt, patrimoineUpdate.updatedAt) &&
        Objects.equals(this.publishedAt, patrimoineUpdate.publishedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatrimoineUpdate {\n");
