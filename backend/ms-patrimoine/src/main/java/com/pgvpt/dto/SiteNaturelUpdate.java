...
public class SiteNaturelUpdate implements PatrimoineUpdate {
   ...
   */
  public SiteNaturelUpdate(String nom, String type, CategoriePatrimoine categorie, String description, Double superficie, NatureSiteNaturel natureSite, String ecosysteme) {
    this.nom = nom;
    this.type = type;
